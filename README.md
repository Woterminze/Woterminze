...
## Привет!
### Я инженер-тестировщик с 2+ годами практического опыта (web, mobile).Изучаю автоматизирвоанное тестирование на JS и Python Планирую стать полноценным full-stack QA :)
## Мое резюме:
