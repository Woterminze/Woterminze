...
## Привет!
### Я инженер-тестировщик с почти 2 годами практического опыта (web, mobile). В свободное время изучаю автоматизацию тестирования на Python и готовлюсь к сдаче ISTQB. Планирую стать полноценным full-stack QA :)
## Мое резюме:
